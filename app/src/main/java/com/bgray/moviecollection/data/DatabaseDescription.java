...
public class DatabaseDescription {
   ...
   public static final String AUTHORITY =
      "com.bgray.moviecollection.data";
   ...
   public static final class Movie implements BaseColumns {
      ...
      public static final String COLUMN_GENRE = "phone";
      public static final String COLUMN_DIRECTOR = "email";
      public static final String COLUMN_YEAR = "street";
      public static final String COLUMN_LENGTH = "city";
